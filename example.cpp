...
long long int one_ring(long long int r) { return 2 + 2 * r; }
...
int main() {
  VecOfVecOfStr v = read_file("A.in");
  ...
  //   // cout<<std::setw(10) << how_many_rings(stoll(v[i][0]), stoll(v[i][1])) << endl;
  //   cout << "Case #" << i << ": " << how_many_rings(stoll(v[i][0]), stoll(v[i][1])) << endl;
  // }
  return 0;
}
